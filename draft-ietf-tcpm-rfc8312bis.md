...
to mitigate this issue, which would allow using a value between *cwnd* 
and *flight_size* to calculate the new *ssthresh* to calculate the 
new ssthresh in {{eqssthresh}}. Some implementations of CUBIC use 
*cwnd* when calculating a new *ssthresh*.
